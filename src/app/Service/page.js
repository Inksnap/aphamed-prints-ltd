...
export const metadata = {
  title: "Our Services",
  description: "Comprehensive printing and branding services including graphic design, web design, large format printing, merchandise, signage, and custom solutions. Professional quality, creative excellence.",
  keywords: ["printing services", "graphic design", "web design", "branding services", "large format printing", "custom merchandise", "signage solutions"],
  openGraph: {
    title: "Our Services | Aphamed Prints LTD",
    description: "Comprehensive printing and branding services for all your business needs",
    type: "website",
  },
};
